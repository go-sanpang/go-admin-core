...
func DriverStringFunc() (id, b64s, answer string, err error) {
	...
	rgb := &color.RGBA{R: 240, G: 240, B: 246, A: 246}
	e.DriverString = base64Captcha.NewDriverString(46, 140, 2, 2, 4, "234567890abcdefghjkmnpqrstuvwxyz", rgb, nil, []string{"wqy-microhei.ttc"})
